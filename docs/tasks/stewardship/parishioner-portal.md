...
- [x] FAM-01.01 — Build all campaign-availability and code-entry states.
- [x] FAM-01.02 — Integrate code/token login and clean session exchange.
- [x] FAM-01.03 — Enforce Testing acknowledgement and banners.
- [x] FAM-01.04 — Gate every Family route by eligibility, interval, mode, and epoch.
- [x] FAM-01.05 — Audit Family access and maintain presence metadata.
- [x] FAM-01.06 — Test access, Testing, token, and lifecycle denial cases.
...
browser cases pass. The [integrated acceptance](../../guides/stewardship-family-acceptance.md)
and [Gate 2 reviews](../../guides/stewardship-gate-2-reviews.md) complete the
lifecycle denial/acceptance checks, including optional-help failure isolation
and durable presence-path revocation. Protected delivery remains pending there.
...
- [x] FAM-02.01 — Build the accessible mobile multi-step form shell.
- [x] FAM-02.02 — Prefill the merged Family model and change indicators.
- [x] FAM-02.03 — Keep drafts in memory and warn on loss or expiry.
- [x] FAM-02.04 — Integrate validation, idle warning, and activity keepalive.
- [x] FAM-02.05 — Test navigation, lost drafts, expiry, and mobile focus.
...
browser tests cover all three engines. The integrated acceptance now covers
all module combinations, section-level editing/focus, in-flight disabling,
draft loss and expiry. Representative automated accessibility/privacy and
full-page mobile/desktop inspection pass; full FAM-08 release scope stays open.
...
- [x] FAM-06.01 — Build the optional additional-information field.
- [x] FAM-06.02 — Build complete response review and attestation.
- [x] FAM-06.03 — Implement atomic Submit with Family-specific source concurrency.
- [x] FAM-06.04 — Render Thank You, queue receipt, and invalidate session.
- [x] FAM-06.05 — Preserve in-memory edits through errors and refreshed-baseline review.
- [x] FAM-06.06 — Enforce Testing acknowledgement at final submission.
- [x] FAM-06.07 — Test duplicate, concurrent-response, source-promotion, and interrupted submissions.
...
The subsequent module increments and integrated acceptance complete review,
concurrency, enabled-section derivation completeness, exact follow-up history,
Thank You/logout and separate Testing consent. As expressly scoped by the master
plan, .04 queues a durable receipt intent only; actual BG-07 delivery is Phase 4.
...
- [x] FAM-07.01 — Prefill repeat visits and prior submission time.
- [x] FAM-07.02 — Integrate source merge without misattributing Admin edits.
- [x] FAM-07.03 — Explain caught-up, pending, and conflicting changes.
- [x] FAM-07.04 — Supersede derived work only upon final Submit.
- [x] FAM-07.05 — Test repeated census, information, and Ministry changes.
...
pending/caught-up/conflict integration with source promotion. Ministry/financial,
terminal/proposed Member and Admin-resolved-value acceptance now passes through
the integrated real owners. This verifies how the Family consumes resolution
states; it does not implement the later Admin publication workflow.
...
Partial evidence: integrated acceptance passes 720 cases across three engines,
representative 320-/1,280-pixel full-flow keyboard/AA checks and visual inspection,
tab-only draft and passive-request privacy, stale/error/expiry cases and the
large-household/500-Ministry fixture. Full current/previous branded browsers,
manual screen readers, delayed mail workers and production-scale measurements
remain with Gates 3/5. All mixed-scope tasks remain open; permitted Low refinements
are retained in the Gate 2 ledger.
