    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("attempt", models.PositiveBigIntegerField(db_default=0, default=0)),
                ("fence", models.PositiveBigIntegerField(db_default=0, default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("not_before", parishkit.stewardship.storage.UTCDateTimeField()),
        ...
        migrations.AddIndex(
            model_name="taskrun",
            index=models.Index(fields=["state", "lease_expires_at"], name="task_lease"),
        ),
        ...
        migrations.AddConstraint(
            model_name="taskrun",
            constraint=models.CheckConstraint(
                condition=models.Q(("task_type__regex", "^[a-z][a-z0-9_]{0,63}$")),
