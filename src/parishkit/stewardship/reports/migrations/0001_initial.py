        ...
        migrations.SeparateDatabaseAndState(
            state_operations=[
                    ...
                    options={
                        ...
                        "indexes": [
                            models.Index(
                                ...
                                name="ministry_export_correlation",
                            ),
                            models.Index(
                                fields=["campaign"], name="ministry_export_campaign"
                            ),
                            models.Index(
                                fields=["source"], name="ministry_export_source"
                            ),
                            models.Index(
                                fields=["configuration"],
                                name="ministry_export_config",
                            ),
                        ],
                    },
                ),
                ...
                migrations.CreateModel(
                    ...
                    options={
                        ...
                        "indexes": [
                            models.Index(
                                fields=["correlation_id"],
                                name="information_export_correlation",
                            ),
                            models.Index(
                                fields=["campaign"], name="information_export_campaign"
                            ),
                            models.Index(
                                fields=["source"], name="information_export_source"
                            ),
                            models.Index(
                                fields=["configuration"],
                                name="information_export_config",
                            ),
                        ],
                    },
                ),
                ...
                migrations.CreateModel(
                    ...
                    fields=[
                        ...
                        (
                            "ministry_snapshot",
                            models.ForeignKey(
                                to="stewardship_reports.ministryexportsnapshot",
                                on_delete=django.db.models.deletion.PROTECT,
                                null=True,
                                db_index=False,
                            ),
                ...
                migrations.AddIndex(
                    ...
                    index=models.Index(
                        fields=["information_snapshot"],
                        name="export_information_snapshot",
                    ),
                ),
                migrations.AddIndex(
                    model_name="exportrequest",
